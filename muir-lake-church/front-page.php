...
<p>Our church continues today to powerfully live out the mission God gave us: “To make followers of Jesus who love God and others selflessly.” With the help of the Holy Spirit we are seeing His Word proclaimed, lives transformed, and our community impacted.</p>
		...
		<div class="promo-links">
			<a href="/leadership">
				...
				<h3>Meet</h3></a>
			<a href="/sermons"><img class="small-link-image" src="<?php bloginfo('template_directory'); ?>/images/listen-wide.jpg"><img class="large-link-image" src="<?php bloginfo('template_directory'); ?>/images/listen.jpg"><h3>Listen</h3></a>
			<a href="/events"><img class="small-link-image" src="<?php bloginfo('template_directory'); ?>/images/calendar-wide.jpg"><img class="large-link-image" src="<?php bloginfo('template_directory'); ?>/images/calendar.jpg"><h3>Events</h3></a>
		</div>
...
<div id="secondary">
	<div class="container">
		...
		?>
	<!--  		<p><strong>CHURCH:</strong> Sunday at 10:00 a.m.</p>
			<p><strong>YOUTH:</strong> Friday at 7:00 p.m.</p>
			<p><strong>UPCOMING EVENTS:</strong> We have no upcoming events at the moment, but we will keep you posted!</p>
			<p><strong>ADDRESS:</strong> Box 2457, Stony Plain, Alberta, T7Z 1X9</p> -->
		</div>
