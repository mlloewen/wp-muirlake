		...
		<div class="container">
			<div class="site-branding">
				...
				<div class="header-left">
					<a href="/"><img  src=data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==></img></a>
<!--					<a href="/"><img  src="<?php bloginfo('template_directory'); ?>/images/logogrd.svg"></img></a> -->
				</div>

				<div class="header-right">
<!--		stop subscription			<div class="email-subscribe">
